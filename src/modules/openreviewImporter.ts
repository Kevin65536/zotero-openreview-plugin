...
export class OpenReviewImporter {
                    ...
                    children: [
                        {
                            ...
                            children: [
                                ...
                                },
                                {
                                    tag: "span",
                                    namespace: "html",
                                    properties: { innerHTML: ` ${getString("dialog-filter-all")}` },
                                },
                            ],
                        },
                        {
                            ...
                            children: [
                                ...
                                },
                                {
                                    tag: "span",
                                    namespace: "html",
                                    properties: { innerHTML: ` ${getString("dialog-filter-oral")}` },
                                },
                            ],
                        },
                        {
                            ...
                            children: [
                                ...
                                },
                                {
                                    tag: "span",
                                    namespace: "html",
                                    properties: { innerHTML: ` ${getString("dialog-filter-poster")}` },
                                },
                            ],
                        },
                    ],
    ...
    static async importFromOpenReview(
        ...
        const progressWin = new ztoolkit.ProgressWindow(getString("progress-title"), {
            closeOnClick: true,
